...
import Text.ParserCombinators.Parsec.Rfc2234NS hiding ( quoted_pair, quoted_string, crlf )
import qualified Text.ParserCombinators.Parsec.Rfc2234NS as Rfc2234

crlf :: CharParser a String 
crlf = Rfc2234.crlfNS
